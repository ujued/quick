...
public interface QuickContext extends WebContext {
     ...
     * @param executor
     */
    QuickContext mapping(String key, Function<WebContext, Object> executor);

    /**
     * 带请求与相应对象的BiArgsRunnable
     *
     * @param key
     * @param executor
     * @return
     */
    QuickContext mapping(String key, BiArgsRunnable<HttpRequest, HttpResponse> executor);
     ...
     * @param executor
     */
    QuickContext mapping(String key, ArgRunnable<WebContext> executor);
