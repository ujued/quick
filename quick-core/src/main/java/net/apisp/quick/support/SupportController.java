...
import net.apisp.quick.ioc.def.NewClassScanner;
...
import net.apisp.quick.ioc.def.SimpleClassScanner;
...
public class SupportController {
	...
	public JSONObject prepareContext(HttpRequest req, HttpResponse resp) {
		...
		ClassScanner classScanner = new NewClassScanner(classpathURI, Quicks.packageName(bootClass));
